package com.hust.qlts.project.config;

import com.hust.qlts.project.filter.CROSFilter;
import com.hust.qlts.project.filter.JWTAuthorizaionFilter;
...
public class WebSecuriyConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests()
                .antMatchers("/authen/**","/img/**","/test/**","/socket/**","/swagger-ui/**").permitAll()
